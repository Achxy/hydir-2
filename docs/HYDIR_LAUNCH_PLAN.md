...
| Execution foundation | `InputSpec v1`, bounded Bubblewrap replay, `NativeReplayReport v1`, `ExecutionSnapshot v1`, sparse reads, `OriginProbe v1` byte-equality checks, and experimental named-symbol/stripped-address GDB/MI capture | Live Linux capture gate, automatic original-byte provenance, Triton resumption, cancellation, WSL2 launch |
