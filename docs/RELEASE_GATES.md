...
| M2 shared product | egui initial window visually inspected on macOS; explicit remote upload/pass/rebuild/annotation headless probes, owner-scoped SQLite revisions/artifacts and analyst facts, authenticated loopback gRPC, durable lift jobs, replay/cancel, Python SDK subset | Durable local-project annotations, reliable visual interaction QA, full typed operation parity, fine-grained roles, quotas/audit, non-loopback TLS, hostile-input isolation |
