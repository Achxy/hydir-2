...
| M1 native vertical slice | Ghidra-free ELF import and scalar CFG-to-LLVM lift; v2 ELF program inventory with load mappings, imports, and relocations; 20 distinct supported functions, 21,168/21,168 tested input pairs across 21 variants; explicit unsupported refusal | Stack/buffer and partial-register semantics, optimization-level diversity, broader ABI and binary corpus; call/reference integration and assumptions |
