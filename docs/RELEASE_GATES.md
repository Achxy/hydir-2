...
| M2 shared product | egui inspection, explicit remote upload, owner-scoped SQLite revisions/artifacts, authenticated loopback gRPC, durable lift jobs, replay/cancel, Python SDK subset | Visual interaction QA, full typed operation parity, fine-grained roles, quotas/audit, non-loopback TLS, hostile-input isolation |
