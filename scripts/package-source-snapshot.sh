...
for required in LICENSE Cargo.lock rust-toolchain.toml Dockerfile.m1 PROVENANCE.md THIRD_PARTY_NOTICES.md crates/hydir-api/proto/hydir.proto crates/hydir-c/src/lib.rs crates/hydir-patch/src/lib.rs crates/hydir-transform/src/lib.rs crates/hydir-server/build.rs native/whole-runtime/runtime.c scripts/demo-recompile.sh scripts/demo-patch.sh scripts/demo-passes.sh; do
