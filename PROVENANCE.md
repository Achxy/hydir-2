...
| Native ELF symbol reader | `object` 0.39.1 | `hydir-backend` | Newly implemented integration | Local inspect/lift demo |
| x86 decoder | `iced-x86` 1.21.0 | `hydir-backend` | Newly implemented integration | Byte-pattern unit tests |
| Scalar LLVM IR emission | No copied upstream code | `hydir-backend` | Newly implemented, narrow subset | LLVM verifier and differential fixture |
