...
| Python API client and generated stubs | First-party `hydir.proto`; `grpcio-tools` 1.84.0 generator | `sdk/python/hydir_sdk` | Newly implemented wrapper and generated protocol bindings | Six Python boundary tests; pass/source/C/patch operations; earlier separate-process SDK smoke only, updated smoke pending |
