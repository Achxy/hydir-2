...
| Python API client and generated stubs | First-party `hydir.proto`; `grpcio-tools` 1.84.0 generator | `sdk/python/hydir_sdk` | Newly implemented wrapper and generated protocol bindings | Four Python unit tests; source/C operations added; prior separate-process SDK smoke |
