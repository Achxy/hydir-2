...
| Desktop workbench | `eframe`/`egui` 0.36.2 | `hydir-gui` | Newly implemented local and explicit remote inspection, pass, scalar patch, and rebuild subset | macOS compile/unit smoke; Linux local/remote operation probes for passes, patching, rebuild/export; full visual QA pending |
